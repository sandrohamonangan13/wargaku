...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'nama_warga' => [
            'required' => 'Kolom NAMA WARGA harus diisi.',
            'string'   => 'Kolom NAMA WARGA harus berupa string.',
            'max'      => 'Kolom NAMA WARGA tidak boleh lebih dari :max karakter.',
        ],
        ...
        'id_cluster'  => [
            'required' => 'Kolom CLUSTER harus diisi.'
        ],
        ...
        'nama_cluster' => [
            'required'  => 'Nama CLUSTER harus diiisi.',
            'string'    => 'Nama CLUSTER harus string.',
            'max'       => 'Nama CLUSTER Maksimum 20 karakter.',
        ],

        'nama_hobi' => [
            'required'  => 'Nama Hobi harus diiisi.',
            'string'    => 'Nama Hobi harus string.',
            'max'       => 'Nama CLUSTER Maksimum 30 karakter.',
        ],
