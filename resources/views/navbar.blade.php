...
<div class="container-fluid">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="{{ url('/') }}">WargaApp</a>
  </div>
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul class="nav navbar-nav">
      ...
      @if (!empty($halaman) && $halaman == 'warga')
        <li class="active"><a href="{{ url('warga') }}">Warga <span class="sr-only">(current)</span></a></li>
      @else
        <li><a href="{{ url('warga') }}">Warga</a></li>
      @endif

      {{-- Cluster --}}
      @if (Auth::check())
        @if (!empty($halaman) && $halaman == 'cluster')
          <li class="active"><a href="{{ url('cluster') }}">cluster <span class="sr-only">(current)</span></a></li>
        @else
          <li><a href="{{ url('cluster') }}">Cluster</a></li>
        @endif
      @endif
